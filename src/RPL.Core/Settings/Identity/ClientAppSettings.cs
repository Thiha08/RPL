namespace RPL.Core.Settings.Identity
{
    public class ClientAppSettings
    {
        ...
        public string[] companyIdsOpenedForDriverSecondment { get; set; }
        public string customerPortalRootDomain { get; set; }
        public string mixpanelInitId { get; set; }
    }
}
