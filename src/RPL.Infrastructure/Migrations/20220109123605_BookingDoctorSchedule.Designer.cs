...
namespace RPL.Infrastructure.Migrations
{
    ...
    [Migration("20220109123605_BookingDoctorSchedule")]
    partial class BookingDoctorSchedule
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RPL.Core.Entities.Project", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RPL.Core.Entities.ToDoItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RPL.Core.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("RPL.Core.Entities.DoctorSchedule", "DoctorSchedule")
                        .WithMany()
            ...
            modelBuilder.Entity("RPL.Core.Entities.ToDoItem", b =>
                {
                    b.HasOne("RPL.Core.Entities.Project", null)
                        .WithMany("Items")
